...
import numpy as np
img1 = image.load_img('train_set/Potato___Late_blight/1.JPG')
#plt.imshow(img1);
#preprocess image
img1 = image.load_img('train_set/Potato___Late_blight/1.JPG', target_size=(256, 256))
...
result = model.predict_classes([prepare('test_set/Potato___Late_blight/2.JPG')])
disease=image.load_img('test_set/Potato___Late_blight/2.JPG')
#plt.imshow(disease)
